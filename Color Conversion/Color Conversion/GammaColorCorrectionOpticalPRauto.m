...
function [colorInfo, gammaTable, originalGuns] = GammaColorCorrectionOpticalPRauto(OptiCALport,PRconnected,PRport,recordingspergun)
...
try
    ...
    save(workspaceFilename,'colorInfo','gammaTable','originalGuns');
